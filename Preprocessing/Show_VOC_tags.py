...
annota_dir = r'/home/skyarrow/Workspace/Drillbit-Detection/Preprocessing/data_crop/Annotations'   #原始voc格式标签文件存放的文件夹，需改成自己的
origin_dir = r'/home/skyarrow/Workspace/Drillbit-Detection/Preprocessing/data_crop/JPEGImages'    #原始图片文件存放的文件夹，需改成自己的
target_dir1 = r'/home/skyarrow/Workspace/Drillbit-Detection/Preprocessing/plot_img'     #绘制完box后的图片存放的文件夹，需改成自己的
